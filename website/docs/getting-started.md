...
conf.update_rate = -1 -- how often should smgf.update() be called. Can be set to a FPS value (eg 30, 60) for a fixed timestep or -1 for a variable timestep. (default: -1)
conf.zoom = 1 -- a zoom
